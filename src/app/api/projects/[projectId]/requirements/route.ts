...
function buildFilterCondition(condition: FilterCondition): Prisma.WorkItemWhereInput | null {
  ...
  switch (field) {
    ...
    case "productName":
      switch (operator) {
        case "contains": return { product: { name: { contains: strValue, mode: "insensitive" } } }
        case "equals": return { product: { name: { equals: strValue, mode: "insensitive" } } }
        case "notEquals": return { NOT: { product: { name: { equals: strValue, mode: "insensitive" } } } }
        case "startsWith": return { product: { name: { startsWith: strValue, mode: "insensitive" } } }
        case "endsWith": return { product: { name: { endsWith: strValue, mode: "insensitive" } } }
      }
      break
    case "moduleName":
      switch (operator) {
        case "contains": return { module: { name: { contains: strValue, mode: "insensitive" } } }
        case "equals": return { module: { name: { equals: strValue, mode: "insensitive" } } }
        case "notEquals": return { NOT: { module: { name: { equals: strValue, mode: "insensitive" } } } }
        case "startsWith": return { module: { name: { startsWith: strValue, mode: "insensitive" } } }
        case "endsWith": return { module: { name: { endsWith: strValue, mode: "insensitive" } } }
      }
      break
    case "sprintName":
      switch (operator) {
        case "contains": return { sprint: { name: { contains: strValue, mode: "insensitive" } } }
        case "equals": return { sprint: { name: { equals: strValue, mode: "insensitive" } } }
        case "notEquals": return { NOT: { sprint: { name: { equals: strValue, mode: "insensitive" } } } }
        case "startsWith": return { sprint: { name: { startsWith: strValue, mode: "insensitive" } } }
        case "endsWith": return { sprint: { name: { endsWith: strValue, mode: "insensitive" } } }
      }
      break
  }
  return null
...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const baseWhere: Prisma.WorkItemWhereInput = {
      ...
      ...(productId && productId !== "unassigned" && { productId }),
      ...(productId === "unassigned" && { productId: null }),
      ...(moduleId && { moduleId }),
    }
